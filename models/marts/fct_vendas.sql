with
    ...
    , joined_tabelas as (
        select
            ...
            , transportadoras.id_transportadora
            , clientes.id_cliente
        ...
        left join transportadoras on pedidos_itens.id_transportadora = transportadoras.id_transportadora
        left join clientes on pedidos_itens.id_cliente = clientes.id_cliente
    )
    , transformacoes as (
        select
            *
